...
const activeweeklistsRouter = require("./activeOnlyWeeklists");
const fetchWeeklistRouter = require("./fetchWeeklist");
...
app.use("/activeweeklists", activeweeklistsRouter);
app.use("/fetchweeklist", fetchWeeklistRouter);
